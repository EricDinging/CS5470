...
5.  **Benchmark Performance**: Once your implementation is correct, run `python src/test.py --mode=benchmark`. This will run a larger test case and report the execution time of both the naive and your custom implementation. Analyze the results in your report.

## How to Run

First, ensure you have a CUDA-enabled GPU and the CUDA Toolkit installed. Then, install the required Python packages:
```
...
python src/test.py --mode=correctness

# Benchmark performance
python src/test.py --mode=benchmark
```
