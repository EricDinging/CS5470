...
class CustomStridedAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Ensure tensors are contiguous before passing them to the C++/CUDA backend.
        # This is a common requirement for custom extensions.
        q = q.contiguous()
        k = k.contiguous()
        v = v.contiguous()
        
        # Call the custom CUDA kernel through the Python binding
